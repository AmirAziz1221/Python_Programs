...
# make a bar plot of size_in_mb vs Category
plt.figure(figsize=(18.8, 6))  # Adjust the width and height values as needed
sns.barplot(x='Category', y='Size_in_Mb', data=df)
...
# bar plot of content rating vs installs 
plt.figure(figsize = (16,6))
